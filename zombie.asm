...
memcmp(const void *s1, const void *s2, uint n) {
  ...
  40:	74 2e                	je     70 <memcmp+0x40>
  42:	01 c6                	add    %eax,%esi
  44:	eb 14                	jmp    5a <memcmp+0x2a>
  ...
  53:	83 c2 01             	add    $0x1,%edx
    while (n--) {
  56:	39 f0                	cmp    %esi,%eax
  58:	74 16                	je     70 <memcmp+0x40>
        if (*p1 != *p2)
  5a:	0f b6 08             	movzbl (%eax),%ecx
  5d:	0f b6 1a             	movzbl (%edx),%ebx
  60:	38 d9                	cmp    %bl,%cl
  62:	74 ec                	je     50 <memcmp+0x20>
            return *p1 - *p2;
  64:	0f b6 c1             	movzbl %cl,%eax
